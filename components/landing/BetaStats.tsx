...
export function BetaStats() {
  return (
    <section className="mt-16 lg:mt-[88px] py-[clamp(34px,5vw,52px)] px-5 sm:px-11 bg-[#0a1421] border-y border-[#17263c]">
      <div className="max-w-[1112px] mx-auto flex flex-col sm:flex-row sm:items-end sm:justify-between gap-10">
        <div className="max-w-[420px]">
          ...
          <h2 className="mt-3 text-[clamp(22px,3vw,30px)] leading-[1.05] font-bold tracking-[-.03em] text-[#f4f9ff]">
