  ...
  return (
    <div className="rounded-xl border border-slate-700 bg-slate-800 overflow-hidden mb-3">
      <div className="px-4 py-3 border-b border-slate-700/60">
        <div className="text-sm font-semibold text-slate-100">Team Builder</div>
      ...
      <div className="px-4">
        <div className="flex items-center justify-between py-2.5 border-b border-slate-700/40">
          <div>
            ...
            <span className="text-xs text-slate-500 ml-2">visible to signed-in members</span>
          </div>
          <Toggle
            enabled={feature.enabled}
            onChange={(val) => updateFeature({ ...feature, enabled: val })}
            disabled={saving}
          />
        </div>
